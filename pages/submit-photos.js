  ...
  return (
    <>
      <div className="mx-auto w-full px-4 lg:px-0 pt-5 lg:w-3/4 mb-16">
        ...
        <P>Help catalogue Aotearoa's wheelie bins.</P>
      </div>
      ...
      <div className="mx-auto w-full px-4 lg:px-0 lg:w-3/4 grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-y-20">
        <div className="">
          ...
          <ul>
            ...
            <Li>
              Like this example image <span className="lg:hidden">👇</span>
              <span className="hidden lg:inline">👉</span>
            </Li>
          </ul>
          <P></P>
          <P>
            Consistent photos make it easier to see the difference between
            different bin designs.
          </P>
        </div>
        <div className="">
          <img src="/images/wellington-example.jpg" alt="Wellington City Bin" />
        </div>
      </div>

      <div className="mx-auto w-full px-4 lg:px-0 lg:w-3/4 my-16">
        <Button href="/upload">Send your photos</Button>
      </div>
    </>
  );
};
